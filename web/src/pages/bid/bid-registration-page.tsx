...
function ProgressStepper({ steps, current }: { steps: typeof STEPS; current: number }) {
...
export default function BidRegistrationPage() {
  ...
  // Receive parcel data from map page navigation
  ...
  return (
    <div className="min-h-svh bg-background">
      ...
      <div className="mx-auto max-w-[760px] px-6 py-8">
        ...
        <h1 className="mb-6 text-2xl font-bold tracking-tight">입찰 공고 등록</h1>
            ...
            <Button
              ...
              onClick={() => {
                toast.success("입찰 공고가 등록되었습니다", {
                  description: `${mockParcel.address} · ${bidCategories.size}개 분야`,
                });
